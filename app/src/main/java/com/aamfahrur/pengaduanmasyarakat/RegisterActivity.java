...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void register() {
        ...
        if (user.isEmpty()){
            ...
            Toast.makeText(RegisterActivity.this, "Harap isi form untuk register", Toast.LENGTH_SHORT).show();
        } else if (!(user.isEmpty() && iNama.isEmpty() && password.isEmpty() && iNik.isEmpty() && iTelp.isEmpty())){
            mAuth.createUserWithEmailAndPassword(user,password).addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                @Override
