    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back = new Intent(DetailPengaduanActivity.this,HomeActivity.class);
                startActivity(back);
                finish();
            }
        });
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent toForm = new Intent(DetailPengaduanActivity.this,TambahPengaduanActivity.class);
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                db.child(id).setValue(tanggapan).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(DetailPengaduanActivity.this, "Berhasil Menambah Tanggapan", Toast.LENGTH_SHORT).show();
                    }
                });
                dialog.dismiss();
            }
    ...
    protected void onStart() {
        ...
        db.orderByChild("id_pengaduan").equalTo(pengaduan.getId_pengaduan()).addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(DetailPengaduanActivity.this));
