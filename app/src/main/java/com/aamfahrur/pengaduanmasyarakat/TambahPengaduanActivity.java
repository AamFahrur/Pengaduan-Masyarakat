...
public class TambahPengaduanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(TambahPengaduanActivity.this,HomeActivity.class);
                startActivity(back);
                finish();
            }
        });
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            db.child(id).setValue(pengaduan).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isComplete()){
                                        Toast.makeText(TambahPengaduanActivity.this, "Berhasil Menambah", Toast.LENGTH_SHORT).show();
                                        Intent toHome = new Intent(TambahPengaduanActivity.this,HomeActivity.class);
                    ...
                    gambar.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            reference.setValue(pengaduan).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    Toast.makeText(TambahPengaduanActivity.this, "Data Diubah", Toast.LENGTH_SHORT).show();
                                    Intent toHome = new Intent(TambahPengaduanActivity.this,HomeActivity.class);
                                    startActivity(toHome);
                                    finish();
                                }
